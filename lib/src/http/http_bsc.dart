...
class RequestBSC {
  static String baseUrl="https://api.bscscan.com/api?apikey=YZIAIW52DPWKRBVETBHW2Z6YX893HAXCUG&";
  static String baseUrl_test="https://api-testnet.bscscan.com/api?";
  // 配置 Dio 实例
  /*static final BaseOptions _options = BaseOptions(
    baseUrl: 'https://api.bscscan.com/api?apikey=YZIAIW52DPWKRBVETBHW2Z6YX893HAXCUG&',
    connectTimeout: 5000,
    receiveTimeout: 3000,
  );*/
